...
class DvfData {
  ...
  @JsonKey(name: 'valeur_fonciere', fromJson: _parsePrice, defaultValue: 0.0)
  final double price;

  @JsonKey(name: 'adresse_numero', defaultValue: '')
  final String streetNumber;

  @JsonKey(name: 'adresse_suffixe', fromJson: _parseSuffix, defaultValue: '')
  ...
  @JsonKey(name: 'latitude', fromJson: _parseCoordinate, defaultValue: 0.0)
  final double latitude;

  @JsonKey(name: 'longitude', fromJson: _parseCoordinate, defaultValue: 0.0)
  final double longitude;

  @JsonKey(name: 'surface_reelle_bati', fromJson: _parseArea, defaultValue: 0.0)
  final double buildingArea;

  @JsonKey(
      name: 'nombre_pieces_principales', fromJson: _parseRooms, defaultValue: 0)
  ...
  static double _parseArea(dynamic value) {
    ...
    if (value is String) {
      try {
        ...
        final cleanString =
            value.trim().replaceAll(',', '.').replaceAll(RegExp(r'[^\d.]'), '');
        return double.tryParse(cleanString) ?? 0.0;
      } catch (e) {
        return 0.0;
      }
  ...
  factory DvfData.fromJson(Map<String, dynamic> json) =>
      _$DvfDataFromJson(json);
